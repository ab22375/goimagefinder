...
func TestLoadImage(t *testing.T) {
	...
	// Test loading
	img, err := imageprocessor.LoadImage(testImagePath)
	if err != nil {
...
func TestComputeAverageHash(t *testing.T) {
	...
	// Load images
	loadedImg1, _ := imageprocessor.LoadImage(path1)
	loadedImg2, _ := imageprocessor.LoadImage(path2)

	hash1, err := imageprocessor.ComputeAverageHash(loadedImg1)
	if err != nil {
		t.Fatalf("Failed to compute average hash 1: %v", err)
	}

	hash2, err := imageprocessor.ComputeAverageHash(loadedImg2)
	if err != nil {
	...
	loadedImg3, _ := imageprocessor.LoadImage(path3)

	hash3, err := imageprocessor.ComputeAverageHash(loadedImg3)
	if err != nil {
...
func TestComputePerceptualHash(t *testing.T) {
	...
	loadedImg, _ := imageprocessor.LoadImage(path)

	hash, err := imageprocessor.ComputePerceptualHash(loadedImg)
	if err != nil {
...
func TestHashComparison(t *testing.T) {
	...
	hash1, _ := imageprocessor.ComputeAverageHash(loadedImg1)
	hash2, _ := imageprocessor.ComputeAverageHash(loadedImg2)
